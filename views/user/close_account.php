            ...
            <div class="col-md-5 p-3 ">
                <div class="p-3 py-7">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Close Account Permanently</h4>
                    </div>
                    <form action="/user/close_account" method="POST" enctype="application/x-www-form-urlencoded">
                        <div class="row">

                            <div class="form-group col-md-12 ">
                                <label for="exampleInputPassword1">Password</label>
                                <div class="input-group">
                                    <input type="password" id="password" name="password" value="<?= isset($data['form_data']['password']) ? $data['form_data']['password'] : '' ?>" class="form-control <?= isset($data['errors']['password']) ? 'is-invalid' : '' ?>" id="pass">
                        ...
                        <div class="mt-2 text-center">
                            <button type="submit" value="submit" class="btn btn-dark profile-button" type="button">Close Account</button>
                        </div>
                    </form>
                </div>
            </div>
