   ...
   <div class="container pt-4">
      ...
      <div class="card mb-4">
         <div class="card-body">
            ...
            <span class="card-text d-block  text-muted">Please note that, make sure to recheck the entire service again!</span>
            <br>
            <form action="/services/delete/" method="POST" >
               <input type="hidden" name="delete_id" value="<?= $data['service']['id'] ?>">
               <button type="submit" name="delete_service" id="delete_service" value="delete_service" href="#" class="btn btn-dark btn-sm">Yes</button>
               <a href="/pages/service_view/<?= $data['service']['id'] ?>" class="btn btn-danger btn-sm">No</a>
            </form>
         </div>
      </div>
                     ...
                     <div class="service-cover-img-overlay overlay-bottom">
                        <div class="row justify-content-between">
                           <div class="col-7 overlay-service-description">
                              <h4 class="card-title mb-1 w-100">Special title treatment</h4>
